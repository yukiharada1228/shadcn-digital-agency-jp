...
export type AccordionSummaryProps = React.ComponentProps<"summary">
...
export type AccordionBackLinkProps = React.ComponentProps<"a">

const AccordionBackLink = React.forwardRef<
  HTMLAnchorElement,
  AccordionBackLinkProps
>(({ className, children, href, ...props }, ref) => (
  <a
    ref={ref}
    data-slot="accordion-back-link"
    className={cn(
      `
...
AccordionBackLink.displayName = "AccordionBackLink"

export { Accordion, AccordionSummary, AccordionContent, AccordionBackLink }
