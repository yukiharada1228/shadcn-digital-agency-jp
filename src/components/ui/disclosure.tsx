...
const disclosureBackLinkVariants = cva(`
...
const DisclosureBackLink = React.forwardRef<
  HTMLAnchorElement,
...
>(({ className, children, href, ...props }, ref) => {
  return (
    <a
      ref={ref}
      data-slot="disclosure-back-link"
      className={cn(disclosureBackLinkVariants(), className)}
      href={href}
      {...props}
    >
      <svg
...
DisclosureBackLink.displayName = "DisclosureBackLink"
